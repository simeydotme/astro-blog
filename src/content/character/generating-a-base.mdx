...
<pre class="astro-code github-dark" style="background: hsl(var(--background));">
  <code>
...
<PromptExample alternate>
  ...
  I choss the anime []"Don't toy with me Miss Nagatoro"](https://en.wikipedia.org/wiki/Don%27t_Toy_with_Me,_Miss_Nagatoro), as it's a 
