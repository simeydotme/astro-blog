...
import GridImages from "@components/reusable/GridImages.astro"
...
import aprilSubtleVariants from 'public/images/characters/step2/april-subtle-variations.webp'
...
<Image src={aprilSubtleVariants} alt="April, reference sheet #4 with subtle variations selected" />

So I will generate 3 more variations of this image using the <MJ text="🪄 Vary (Subtle)" active /> 
feature. These 3 variations should be quite similar in style and give me a strong set of references to use.
